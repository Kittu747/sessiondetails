...
import readvelocity from '../../Assets/ra-org.png';
...
const wrapperStyle = { width: 250, margin: 50, height: 30 };
    ...
    render() {
        ...
        return (
            <div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-8 verticalcenteralign'>
                                        <div className='row verticalcenteralignrow'>
                                            <div className='profiletxt'>Namrata Sarma</div>
                                        </div>
                                        <div className='row verticalcenteralignrow'>
                                            <div className='col-md-6'>
                                                <p className={Styles.namestd}>R# std1234</p>
                                            </div>
                                            <div className='col-md-6'>
                                                <p className={Styles.namestd}>R# std1234</p>
                                            </div>
                ...
                <div className="row" style={{backgroundColor: 'white', borderRadius: '4px', margin: '20px 0 20px 0', padding: '18px 5px 18px 5px', width: '99.5%'}}>
                    <div style={{width: '94%'}}>    
                        <Carousel
                                ...
                                <div className={ Styles.verticalcenteralignrow} style={{ width: '100%' }} >
                    ...
                    <div className='row' style={{marginBottom: '-20px'}}>
                        <div className='col-md-6'>
                            <div className={Styles.raclass}>
                                <img src={readvelocity} style={{marginLeft: '3%'}} />
                                <div className={Styles.RAtxt}>Read Velocity</div>
                                <div className={Styles.RAtxt}>4.25<img src={raarrow} /></div>
                    ...
                    <div className='row' style={{ padding: '20px 0px 20px 0px'}}>
                        <div className='col-md-5'>
                            <div className='row'>
                                ...
                                <div className='col-md-7 verticalcenteralign'>
                        ...
                        <div className='row stdsection' style={{ marginLeft: '-13px' }}>
                            ...
                            <div className='col-md-4 verticalcenteralign'>
                                <div className='row' style={{ marginTop: '10%' }}>
                                    <div className='col-md-10 verticalcenteralign'>
